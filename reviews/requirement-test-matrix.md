...
| **RQ-DOMAIN-TIMER** | requirement-domain-timer | **LM-NAMED-TIMER-DOMAIN** (+ base **LM-SHELL-INTERNAL-VOLATILE-TIMER**) | **PM-DOMAIN-TEST-PLAN** | **TP-TIMER-01..07**; **TP-STORAGE-01/02** | `test_timer_domain.sh` | **have** |
