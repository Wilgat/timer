...
**Last update:** 2026-07-19 (class gate + JSON number types)
...
| L-JSON-01 | Domain list JSON `timers` claimed as array but emitted as escaped string | `timer --json list` → `timers` is JSON array; suite TP-JSON-01 | T-JSON-01 | **Closed** (2026-07-16 fix) |
| L-JSON-02 | Domain elapsed/count JSON fields as quoted strings vs numbers | status/stop `@minutes`/`@seconds`/`@elapsed`; list `@count`; suite TP-JSON-02 | T-JSON-02 | **Closed** (2026-07-19 fix) |
