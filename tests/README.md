...
|-------|------|-------------|--------------|
| CLI surface | `test_cli.sh` | TP-CLI, TP-CSUM-01/05, TP-U-01, TP-CLI-12, **TP-TX-01..05**, **TP-TX-08** | `RQ-SHELL-CLI-INTERFACE`, `RQ-SHELL-OUTPUT-REQUIREMENTS`, `RQ-SHELL-AUTOMATIC-CHECKSUM`, `RQ-SHELL-SCRIPT-CODING` |
