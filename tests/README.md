...
|-------|------|-------------|--------------|
| CLI surface | `test_cli.sh` | TP-CLI, TP-CSUM-01/05, TP-U-01, TP-CLI-12, **TP-CLI-16/17/29/30**, **TP-TX-01..05**, **TP-TX-08**, **TP-TX-09** | `RQ-SHELL-CLI-INTERFACE`, `RQ-SHELL-CLI-DEFAULT-INTERACTION`, `RQ-SHELL-OUTPUT-REQUIREMENTS`, `RQ-SHELL-AUTOMATIC-CHECKSUM`, `RQ-SHELL-SCRIPT-CODING`, `RQ-SHELL-PATH-AND-SHELL-SUPPORT` |
| Install lifecycle | `test_install_lifecycle.sh` | TP-LC, TP-CSUM-02..04, **TP-LC-20..22** | `RQ-SHELL-SELF-MANAGEMENT`, `RQ-SHELL-IDEMPOTENCY`, `RQ-SHELL-AUTOMATIC-CHECKSUM`, `RQ-SHELL-PATH-AND-SHELL-SUPPORT` |
